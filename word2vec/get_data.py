...
def maybe_download(filename,expected_bytes):
    ...
    if statinfo.st_size == expected_bytes:
        ...
        raise Exception(
            'Failed to verify'+filename+'. Can you get to ot with a browser?'
        )
    return filename
...
# we pick up a random validation set to sample nearest neighbors. Here we limit the validation samples
