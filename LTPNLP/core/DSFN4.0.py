            ...
            for itemWord in sentence.words:
                ...
                if (itemWord.head_word == None and itemWord.postag == "v" ) or (itemWord.postag == "v" and
                    ...
                    if itemWord.head_word==None:
                        ...
                        """
                        新增，precious上升，recall下降
                        """
                        if itemWord.dependency == "COO" or self.get_entity_num_between(itemWord, itemWord.head_word,
                                                                                       sentence) == 0:
...
if __name__ == '__main__':
    ...
    # print(dsfn.getSPO2(sentence_list))

    print(dsfn.getSPO2(["厉善麟的祖父厉子嘉，在清朝同治和光绪年间，任内务府都统，深受慈禧信任"]))
    # print(dsfn.getSPO2(["昆明湖是清代皇家诸园中最大的湖泊"]))
