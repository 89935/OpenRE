import step3_filterCandidateRelations_ForBeforeAndAfter
import json

file_path = "..\\document-level-output\\"
file_name_dict = dict()
file_name_dict['loc-loc'] = "loc_loc_triples8.json"
file_name_dict['loc-per'] = "loc_per_triples8.json"
file_name_dict['per-loc'] = "per_loc_triples8.json"
file_name_dict['loc-org'] = "loc_org_triples8.json"
file_name_dict['per-per'] = "per_per_triples8.json"
file_name_dict['per-org'] = "per_org_triples8.json"
file_name_dict['org-org'] = "org_org_triples8.json"
...
def filterAllTriples(type_list,relationWords):
    ...
    for type in type_list:
        ...
        candidateTriples = step3_filterCandidateRelations_ForBeforeAndAfter.readJsonFile(candidateTriples_file_name)
...
def writeJsonFile(jsonDict,type_list,fileName):
    ...
    for type in type_list:
        filePath += "(" + type + ")+"
    with open('..\\document-level-output\\windowWord1_longestEntity_'+filePath+"\\"+fileName, 'w',encoding='utf-8') as json_file:
...
if __name__ == "__main__":
    ...
    relationWords,relationWordsAndScore = step3_filterCandidateRelations_ForBeforeAndAfter.filterCandidateRel(type_list, 100, 50)
    print(relationWords)
