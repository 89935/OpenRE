    ...
    for line in result_list:
        ...
        for word_pos in word_pos_list:
            ...
            if word not in word_key_list:
                word_pos_freq_dict[tuple([word,[pos]])] = 1
            else:
                if pos not in pos_list:
                    pos_list.append(pos)
                word_pos_freq_dict[tuple([word,pos_list])] = word_pos_freq_dict[word_pos]+1
...
if __name__ == "__main__":
    ...
    # with open('entity_verb_result\\' + "context_word_freq_dict.json", 'w',
    #           encoding='utf-8') as json_file:
    #     json_file.write(json.dumps(word_freq_dict,ensure_ascii=False))
